...
"""
Based on trackagileVer10.py
Use relative distance as input
The velocity and accleration in IMU input is relative as well
"""
...
def get_args():
	custom_parameters = [
		...
		# model setting
		{"name": "--param_save_path", "type":str, "default": '/home/wangzimo/VTT/VTT/aerial_gym/param_saved/track_agileVer11.pth',
			"help": "The path to model parameters"},
		{"name": "--param_load_path", "type":str, "default": '/home/wangzimo/VTT/VTT/aerial_gym/param_saved/track_agileVer11.pth',
			"help": "The path to model parameters"},
