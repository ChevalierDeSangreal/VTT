...
"""
Based on tracktransferVer0.py
Added embedding storage function
"""
...
def get_args():
	custom_parameters = [
		...
		{"name": "--experiment_name", "type": str, "default": "track_transferVer1", "help": "Name of the experiment to run or load."},
...
if __name__ == "__main__":
	...
	for epoch in range(args.num_epoch):
		...
		if (epoch + 1) % 50 == 0 and len(all_embeddings):
			...
			save_path = f"/home/wangzimo/VTT/VTT/aerial_gym/data/{epoch}.pt"
			torch.save({
