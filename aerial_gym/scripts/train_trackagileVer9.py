...
def get_args():
    custom_parameters = [
        ...
        # train setting
        {"name": "--learning_rate", "type":float, "default": 5.6e-4,
        ...
        # model setting
        {"name": "--param_save_path", "type":str, "default": '/home/wangzimo/VTT/VTT/aerial_gym/param_saved/track_agileVer9.pth',
            "help": "The path to model parameters"},
        {"name": "--param_load_path", "type":str, "default": '/home/wangzimo/VTT/VTT/aerial_gym/param_saved/track_agileVer9.pth',
            "help": "The path to model parameters"},
...
if __name__ == "__main__":
    ...
    for epoch in range(args.num_epoch):
        ...
        for step in range(args.len_sample):
            ...
            tmp_input = torch.cat((now_quad_state[:, 6:], rel_dis), dim=1)
