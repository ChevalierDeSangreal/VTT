...
from aerial_gym.models import TrackAgileModuleVer4, TrackAgileModuleVer5, TrackAgileModuleVer6
...
Do not use velocity and attitude
Only use acceleration
"""
...
def get_args():
	custom_parameters = [
		...
		# model setting
		{"name": "--param_save_path", "type":str, "default": '/home/wangzimo/VTT/VTT/aerial_gym/param/track_agileVer14.pth',
			"help": "The path to model parameters"},
		{"name": "--param_load_path", "type":str, "default": '/home/wangzimo/VTT/VTT/aerial_gym/param/track_agileVer14.pth',
			"help": "The path to model parameters"},
...
if __name__ == "__main__":
	...
	model = TrackAgileModuleVer6(device=device).to(device)
	...
	for epoch in range(args.num_epoch):
		...
		input_buffer = torch.zeros(args.slide_size, args.batch_size, 3+3).to(device)
		...
		for step in range(args.len_sample):
			...
			tmp_input = torch.cat((body_acc, body_rel_dis), dim=1)
