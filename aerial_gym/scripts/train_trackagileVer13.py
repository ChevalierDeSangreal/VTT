...
def get_args():
	custom_parameters = [
		...
		{"name": "--experiment_name", "type": str, "default": "track_agileVer13", "help": "Name of the experiment to run or load."},
		...
		# model setting
		{"name": "--param_save_path", "type":str, "default": '/home/wangzimo/VTT/VTT/aerial_gym/param/track_agileVer13.pth',
...
if __name__ == "__main__":
	...
	for epoch in range(args.num_epoch):
		...
		for step in range(args.len_sample):
			...
			tmp_input = torch.cat((body_vel, body_acc, now_quad_state[:, 3:6], image_feature), dim=1)
