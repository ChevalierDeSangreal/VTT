...
from aerial_gym.utils import task_registry, velh_lossVer5, agile_lossVer1, AgileLoss, agile_lossVer5, agile_lossVer4
from aerial_gym.models import TrackAgileModuleVer4, TrackAgileModuleVer3
...
def get_args():
    custom_parameters = [
        ...
        {"name": "--experiment_name", "type": str, "default": "track_agileVer8", "help": "Name of the experiment to run or load."},
        ...
        # model setting
        {"name": "--param_save_path", "type":str, "default": '/home/wangzimo/VTT/VTT/aerial_gym/param_saved/track_agileVer8.pth',
            "help": "The path to model parameters"},
        {"name": "--param_load_path", "type":str, "default": '/home/wangzimo/VTT/VTT/aerial_gym/param_saved/track_agileVer8.pth',
            "help": "The path to model parameters"},
    ...
    with torch.no_grad():
        for epoch in range(args.num_epoch):
            ...
            for step in range(args.len_sample):
                ...
                writer.add_scalar(f'Aux Loss', old_loss.aux[item_tested], step)
