...
class TrackGroundVer8(BaseTask):
    ...
    def _create_envs(self):
        ...
        # heightfield[0:num_rows, :] = random_uniform_terrain(new_sub_terrain(), min_height=-0.1, max_height=0.4, step=0.2, downsampled_scale=0.5).height_field_raw
        heightfield[0:num_rows, :] = discrete_obstacles_terrain(new_sub_terrain(), max_height=0.3, min_size=1., max_size=5., num_rects=2000).height_field_raw
