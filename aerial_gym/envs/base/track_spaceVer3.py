...
""" 
    Modified based on track_spaceVer2.py
...
class TrackSpaceVer3(BaseTask):
    ...
    def set_reset_idx(self, env_ids):
        ...
        self.root_states[env_ids, 0:2] = rand_circle_point(num_resets, 5, self.device) + self.tar_traj[env_ids, self.count_step[env_ids], :2]
